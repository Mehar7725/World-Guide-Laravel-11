<div id="header" class="app-header">
  ...
  <div class="brand">
    <a href="index.html" class="brand-logo">
      ...
      <span class="brand-text">WORLD ADMIN</span>
    </a>
  </div>
  <!-- END brand -->
    ...
    <div class="menu-item dropdown dropdown-mobile-full">
      <a href="#" data-bs-toggle="dropdown" data-bs-display="static" class="menu-link">
        <div class="menu-img online">
          <img src="assets/admin/img/user/profile.jpg" alt="Profile" height="60">
        </div>
        <div class="menu-text d-sm-block d-none w-170px">Adel Aloqayli</div>
      </a>
      <div class="dropdown-menu dropdown-menu-end me-lg-3 fs-11px mt-1">
        ...
        <a class="dropdown-item d-flex align-items-center" href="/admin-logout">LOGOUT <i class="bi bi-toggle-off ms-auto text-theme fs-16px my-n1"></i></a>
      </div>
    </div>
  </div>
  <!-- END menu -->
