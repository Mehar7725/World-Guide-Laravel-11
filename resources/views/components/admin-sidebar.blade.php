    ...
    <div class="menu">
      ...
      <div class="menu-item has-sub">
        ...
        <div class="menu-submenu">
          <div class="menu-item">
            <a href="email_inbox.php" class="menu-link">
              <span class="menu-text">Inbox</span>
            </a>
          </div>
          <div class="menu-item">
            <a href="email_compose.php" class="menu-link">
              <span class="menu-text">Compose</span>
            </a>
          </div>
          <div class="menu-item">
            <a href="email_detail.php" class="menu-link">
      ...
      <div class="menu-submenu">
        <div class="menu-item">
          <a href="/country-management" class="menu-link">
        ...
        <div class="menu-submenu">
          ...
          <div class="menu-item">
            <a href="/city-management" class="menu-link">
