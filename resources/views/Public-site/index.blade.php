...
<script src="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/js/toastr.min.js"></script>
  ...
  <body>
     ...
     <div class="container-fluid header-sec">
            <div class="row">
                <div class="col-md-12 p-0">
                    <img src="assets/public-site/img/header.jpg">
                </div>
            </div>
     </div>
    <!-- =========== HEADER END HERE ========= -->
     <div class="container mt-5">
        <div class="row">
            <div class="col-md-12 worldguide-text">
                <h1>World Guide</h1>
                <h4>Discovering the World</h4>
                <p>Our world Guides aims at providing an up-to-date tourist and travel information, especially for specific cities and countries around the world.
                <br><br>
                    The travel guides of ours are filled with useful and important information, for example, about tourist attractions, travel tips, monuments and major landmarks, accommodation, nearby excursions, city transport, restaurants and shopping, airports etc. We currently have 1200 travel guides, new guides, maps and lovely pictures are frequently added. The World Guides are simple to read and its pages are filled with suggestions and advice. Also, our weekly publications are fun to read.</p>
            </div>
        </div>
     </div>
    <!-- =========== MAP START HERE ========= -->
     <div class="container map-sec mt-5">
        <div class="row">
            <div class="col-md-12">
                <h1>Just Press On Country You Want To Visit On The Map</h1>
                <svg
   style="fill: #b9b9b9;height:100vh;width:100%"
   ...
   sodipodi:docname="World_map_-_low_resolution.svg"><metadata
     id="metadata346"><rdf:RDF><cc:Work rdf:about=""><dc:format>image/svg+xml</dc:format><dc:type rdf:resource="http://purl.org/dc/dcmitype/StillImage" /></cc:Work>
    ...
    <!-- =========== MAP END HERE ========= -->
    <!-- =========== CHOOSE START HERE ========= -->
     <div class="container-fluid choose-sec mt-5">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1>Choose</h1>
            ...
            <div class="row">
              ...
              <div class="col-lg-4 col-md-6 mt-5">
                <a  href="{{ route('country.show', ['name' => $item->country_name ?? 'unknown', 'id' => $item->id, 'code' => $item->country_code ?? 'NA']) }}" >
                    <div class="card" style="width: 100%;">
                        <img src="assets/country_img/{{$item->country_image}}" alt="{{$item->country_name}}" class="card-img-top">
                        <div class="card-body">
                          <a href="{{ route('country.show', ['name' => $item->country_name ?? 'unknown', 'id' => $item->id, 'code' => $item->country_code ?? 'NA']) }}" class="btn btn-primary"><i class="fa-solid fa-location-dot"></i> {{$item->country_name}}</a>
                        </div>
                      </div>
                </a>
               </div> 
                   ...
                   {{-- <div class="col-lg-4 col-md-6 mt-5">
                    <a href="#">
                        <div class="card" style="width: 100%;">
                            ...
                            <div class="card-body">
                              <a href="#" class="btn btn-primary"><i class="fa-solid fa-location-dot"></i> New Zealand</a>
                            </div>
                          </div>
                    </a>
                   </div>  --}}
    ...
    {{-- <div class="container world-ads-sec">
        <div class="row row-cols-1 row-cols-md-3 g-4">
          ...
          <div class="col-lg-4 col-md-6 col-12">
            <div class="card h-100">
              <img src="assets/public-site/img/ad3.jpg" class="card-img-top" alt="...">
              <div class="card-body">
                <h5 class="card-title">CR Paradise</h5>
                <button type="button" class="btn btn-outline-secondary disabled">Be the first to review!</button> <span><i class="fa-solid fa-location-dot"></i> Iran</span>
              </div>
              <a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal">
                <div class="card-footer">
                  <small class="text-muted"><i class="fa-solid fa-map-pin"></i> Show Map</small>
                </div>
              </a>
            </div>
          </div>
    ...
    <div class="modal fade map-modal" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  document.addEventListener('DOMContentLoaded', function () {
      ...
      document.querySelectorAll('svg path[title]').forEach((countryPath) => {
          ...
          countryPath.addEventListener("mouseenter", function (e) {
              tooltip.innerText = countryPath.getAttribute("id");
              tooltip.style.display = "none"; 
          ...
          countryPath.addEventListener("click", function () {
              const country = countryPath.getAttribute("id");
