    ...
    <div class="flex flex-col">
      ...
      >
        ...
        <div class="flex w-full justify-between items-center">
          ...
          <button
            class="px-8 py-2 rounded-lg bg-gray-500 text-white hover:text-black hover:bg-blue-400 text-xl font-thin transition-all ease-in-out duration-700"
            id="login-btn"
          >
            Login
          </button>
      ...
      <div class="py-8">
        <div class="flex justify-center gap-x-2 py-5">
          <a href="./sign-up.html" class="hover:text-blue-500 cursor-pointer">
            Register
          </a>
