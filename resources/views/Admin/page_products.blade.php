...
<head>
	<meta charset="utf-8">
	<title>WORLD ADMIN | Categories</title>
	...
	<div id="app" class="app">
		...
		<div id="content" class="app-content">
			<div class="d-flex align-items-center mb-3">
				...
				<div class="ms-auto">
					<a href="#" class="btn btn-outline-theme"><i class="fa fa-plus-circle fa-fw me-1"></i> Add Product</a>
				</div>
			</div>
									...
									<tr>
										...
										<td>
											<div class="d-flex align-items-center">
												...
												<div class="ms-3">
													<a href="page_product_details.html" class="text-inverse text-opacity-75 text-decoration-none">Eco-friendly fashion, organic cotton, slow fashion polo shirts</a>
												</div>
											</div>
										</td>
									...
									<tr>
										...
										<td>
											<div class="d-flex align-items-center">
												...
												<div class="ms-3">
													<a href="page_product_details.html" class="text-inverse text-opacity-75 text-decoration-none">Nike Shoes (Red Color)</a>
												</div>
											</div>
										</td>
									...
									<tr>
										...
										<td>
											<div class="d-flex align-items-center">
												...
												<div class="ms-3">
													<a href="page_product_details.html" class="text-inverse text-opacity-75 text-decoration-none">Nike Air Max (Blue Color)</a>
												</div>
											</div>
										</td>
										<td class="align-middle">19 in stock for 1 variants</td>
									...
									<tr>
										...
										<td>
											<div class="d-flex align-items-center">
												...
												<div class="ms-3">
													<a href="page_product_details.html" class="text-inverse text-opacity-75 text-decoration-none">Skate Sneaker (Orange Color)</a>
												</div>
											</div>
										</td>
										<td class="align-middle">19 in stock for 1 variants</td>
									...
									<tr>
										...
										<td>
											<div class="d-flex align-items-center">
												...
												<div class="ms-3">
													<a href="page_product_details.html" class="text-inverse text-opacity-75 text-decoration-none">Teen Fashion T-shirt (Black)</a>
												</div>
											</div>
										</td>
									...
									<tr>
										...
										<td>
											<div class="d-flex align-items-center">
												...
												<div class="ms-3">
													<a href="page_product_details.html" class="text-inverse text-opacity-75 text-decoration-none">Levis Blue Jeans</a>
												</div>
											</div>
										</td>
									...
									<tr>
										...
										<td>
											<div class="d-flex align-items-center">
												...
												<div class="ms-3">
													<a href="page_product_details.html" class="text-inverse text-opacity-75 text-decoration-none">Boots (White Color)</a>
												</div>
											</div>
										</td>
										<td class="align-middle">19 in stock for 1 variants</td>
									...
									<tr>
										...
										<td>
											<div class="d-flex align-items-center">
												...
												<div class="ms-3">
													<a href="page_product_details.html" class="text-inverse text-opacity-75 text-decoration-none">Hiking Boots</a>
												</div>
											</div>
										</td>
									...
									<tr>
										...
										<td>
											<div class="d-flex align-items-center">
												...
												<div class="ms-3">
													<a href="page_product_details.html" class="text-inverse text-opacity-75 text-decoration-none">Dress (Pink)</a>
												</div>
											</div>
										</td>
