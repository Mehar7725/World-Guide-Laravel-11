...
<head>
	<meta charset="utf-8">
	<title>WORLD ADMIN | Inbox (20+)</title>
			...
			<div class="card h-100">
				...
				<div class="mailbox">
					...
					<div class="mailbox-toolbar">
						...
						<div class="mailbox-toolbar-item"><a href="email_compose.html" class="mailbox-toolbar-link text-inverse bg-inverse bg-opacity-15">New Message <i class="fa fa-pen fs-12px ms-1"></i></a></div>
					</div>
					<!-- END mailbox-toolbar -->
					<!-- BEGIN mailbox-body -->
