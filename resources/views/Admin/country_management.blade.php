...
<head>
    <meta charset="utf-8">
    <title>HUD | Country Management</title>
    ...
    <div id="app" class="app">
        ...
        <div id="content" class="app-content">
            <div class="card">
                <div class="card-header d-flex align-items-center">
                    <h3 class="mb-0">Country Management</h3>
                    <a href="/country-management-add" class="btn btn-theme ms-auto" >   Add New Country </a>
                            ...
                            <tbody>
                                @if ($country)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a  href="/edit-country-{{$item->id}}" class='btn btn-sm btn-primary me-1'  >Edit</a>
                                            <a href="/delete-country/{{$item->id}}" class='btn btn-sm btn-danger' >Delete</a>
                                          </td>
                                    </tr>
        ...
        <nav class="pagination-outer" aria-label="Page navigation">
            <ul class="pagination" style="justify-content: center;"> 
                ...
                @else
                <li class="page-item">
                  <a   class="page-link" href="{{ $country->previousPageUrl() }}" rel="prev" aria-label="@lang('pagination.previous')">
                ...
                {{-- Pagination Elements --}}
                @php
                    $start = max($country->currentPage() - 2, 1);
                    $end = min($country->currentPage() + 2, $country->lastPage());
                @endphp
                ...
                <li class="page-item">
                  <a class="page-link" href="{{ $country->nextPageUrl() }}" rel="next" aria-label="@lang('pagination.next')">
                    »
                  </a>
              </li>
