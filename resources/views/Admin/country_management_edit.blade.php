...
<body>
    ...
    <form id="myForm" action="/update-new-country" method="POST" enctype="multipart/form-data"> @csrf
        <input type="hidden" name="id" value="{{$country->id}}" class="form-control url-input" >
        <!-- BEGIN #app -->
        ...
        <div class="left-menu">
            <div class="quick-access-item">
                ...
                <div class="url-input-container"  id="fact_btn_div">
                    <input type="text" name="facts_url" value="{{$country->facts_url}}" id="country_facts_url" class="form-control url-input" 
            ...
            <div class="quick-access-item">
                ...
                <div class="url-input-container"  id="history_btn_div" >
                    <input type="text" name="history_url" value="{{$country->history_url}}" id="history_url" class="form-control url-input" 
            ...
            <div class="quick-access-item">
                ...
                <div class="url-input-container"  id="dining_btn_div">
                    <input type="text" name="dining_url" value="{{$country->dining_url}}" id="dining_url" class="form-control url-input" 
            ...
            <div class="quick-access-item">
                ...
                <div class="url-input-container" id="visa_btn_div">
                    <input type="text" name="visa_info_url" value="{{$country->visa_info_url}}" id="visa_info_url" class="form-control url-input" 
            ...
            <div class="quick-access-item">
                ...
                <div class="url-input-container"  id="visa_light_btn_div">
                    <input type="text" name="visa_light_url" value="{{$country->visa_light_url}}" id="visa_light_url" class="form-control url-input" 
            ...
            <div class="quick-access-item">
                ...
                <div class="url-input-container" id="tour_btn_div" >
                    <input type="text" name="tours_url" value="{{$country->tours_url}}" id="tour_url" class="form-control url-input" 
        ...
        <div class="top-buttons d-flex justify-content-center gap-2">
            <div class="quick-access-item">
                ...
                <div class="url-input-container"  id="constitution_btn_div">
                    <input type="text" value="{{$country->constitution_url}}" name="constitution_url" id="constitution_url" class="form-control url-input" 
            ...
            <div class="quick-access-item">
                ...
                <div class="url-input-container" id="emergency_btn_div">
                    <input type="text" value="{{$country->emergency_url}}" name="emergency_url" id="emergency_url" class="form-control url-input" 
            ...
            <div class="quick-access-item">
                ...
                <div class="url-input-container"  id="embassies_btn_div">
                    <input type="text" value="{{$country->embassies_url}}" name="embassies_url" id="embassies_url" class="form-control url-input" 
            ...
            <div class="quick-access-item">
                ...
                <div class="url-input-container"  id="news_btn_div">
                    <input type="text" value="{{$country->news_url}}" name="news_url" id="news_url" class="form-control url-input" 
                ...
                <div id="addCountryForm">
                    ...
                    <div class="form-section">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="currency-image-upload">
                                    ...
                                    <div class="image-preview mt-2" id="countryPreview">
                                        <img src="assets/country_img/{{$country->country_image}}" alt="Country preview" style="max-width: 100%; display: block;">
                                    </div>
                                </div>
                            </div>

                            <div class="col-md-6 mb-3">
                                <label class="form-label">Change Country Status</label>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" value="{{$country->country_name}}" name="country_name" class="form-control" id="country_name" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Country Code</label>
                                <input type="text" value="{{$country->country_code}}" name="country_code" class="form-control" id="country_code"  required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="url" value="{{$country->country_video}}" name="country_video" class="form-control" id="video_url">
                        ...
                        <div class="video-container" id="videoPreview">
                            <iframe width="560" height="315" src="{{$country->country_video}}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen="">
                        </iframe>
                    </div>
                    </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="url" value="{{$country->country_map}}" name="country_map" class="form-control" id="map_url">
                            <div class="alert alert-danger error-message" style="display: none;" id="mapError"></div>
                        </div>
                        <div class="map-container" id="mapPreview"> {!!$country->country_map!!}  </div>
                    </div>
                        ...
                        <div class="wpsm_panel">
                            ...
                            <div class="wpsm_panel-body">
                                <textarea class="form-control" name="best_time" rows="3" id="best_time" 
                                          placeholder="Best time to visit this country">{{$country->best_time}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="wpsm_panel">
                            ...
                            <div class="wpsm_panel-body">
                                <textarea class="form-control" name="transportation" rows="3" id="transportation" 
                                          placeholder="Transportation information">{{$country->transportation}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="wpsm_panel">
                            ...
                            <div class="wpsm_panel-body">
                                <textarea class="form-control" name="weather" rows="3" id="weather" 
                                          placeholder="Weather information">{{$country->weather}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="wpsm_panel">
                            ...
                            <div class="wpsm_panel-body">
                                <textarea class="form-control" name="information" id="information" rows="3"  
                                          placeholder="General information">{{$country->information}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="wpsm_panel">
                            ...
                            <div class="wpsm_panel-body">
                                <textarea class="form-control" name="language" rows="3" id="language" 
                                          placeholder="Language">{{$country->language}}</textarea>
                            </div>
                        </div>
        ...
        <div class="row">
            <div class="col-md-8">
                <textarea class="form-control" rows="3" name="electric" id="electric" 
                          placeholder="Electrical system information">{{$country->electric}}</textarea>
            </div>
            <div class="col-md-4">
                <div class="electric-image-upload">
                    ...
                    <div class="image-preview mt-2" id="electricPreview">
                        <img src="assets/country_img/electric/{{$country->electric_image}}" alt="Electric plug preview" style="max-width: 100%; display: block;">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-8">
                <textarea class="form-control" name="currency" rows="3" id="currency_info" 
                          placeholder="Currency information">{{$country->currency}}</textarea>
            </div>
            <div class="col-md-4">
                <div class="currency-image-upload">
                    ...
                    <div class="image-preview mt-2" id="currencyPreview">
                        <img src="assets/country_img/currency/{{$country->currency_image}}" alt="Currency preview" style="max-width: 100%; display: block;">
                    </div>
                </div>
            </div>
        </div>
...
function previewImage(input, previewId) {
 ...
 let input = @json($country->country_map);
 const mapError = document.getElementById('mapError');
 const mapPreview = document.getElementById('mapPreview');
