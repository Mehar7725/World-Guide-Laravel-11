...
<head>
	<meta charset="utf-8">
	<title>WORLD ADMIN | Form Elements</title>
								...
								<div id="checkboxes" class="mb-5">
									...
									<div class="card">
										<div class="card-body">
											<div class="row mb-n3">
												<div class="col-xl-6">
													<div class="small text-inverse text-opacity-50 mb-1"><b class="fw-bold">DEFAULT CHECKBOX</b></div>
												...
												<div class="col-xl-6">
													<div class="small text-inverse text-opacity-50 mb-1"><b class="fw-bold">INLINE CHECKBOX</b></div>
													<div class="form-group mb-3">
								...
								<div id="radios" class="mb-5">
									...
									<div class="card">
										<div class="card-body">
											<div class="row mb-n3">
												<div class="col-xl-6">
													<div class="small text-inverse text-opacity-50 mb-1"><b class="fw-bold">DEFAULT RADIO</b></div>
													<div class="form-group mb-4">
														<div class="form-check">
												...
												<div class="col-xl-6">
													<div class="small text-inverse text-opacity-50 mb-1"><b class="fw-bold">INLINE RADIO</b></div>
													<div class="form-group mb-3">
														<div class="form-check form-check-inline">
