...
<body>
    <form id="myForm" action="/add-new-city" method="POST" enctype="multipart/form-data"> @csrf
    <!-- Left Menu -->
    <div class="left-menu">
        <div class="menu-item">
            ...
            <div class="url-input-container"  id="business_btn_div">
                <input type="text" name="business_url" id="business_url" class="form-control url-input" 
        ...
        <div class="menu-item">
            ...
            <div class="url-input-container"  id="taxi_btn_div">
                <input type="text" name="taxi_url" id="taxi_url" class="form-control url-input" 
        ...
        <div class="menu-item">
            ...
            <div class="url-input-container"  id="law_btn_div">
                <input type="text" name="law_url" id="law_url" class="form-control url-input" 
        ...
        <div class="menu-item">
            ...
            <div class="url-input-container"  id="lawyer_btn_div">
                <input type="text" name="lawyer_url" id="lawyer_url" class="form-control url-input" 
        ...
        <div class="menu-item">
            ...
            <div class="url-input-container"  id="event_btn_div">
                <input type="text" name="event_url" id="event_url" class="form-control url-input" 
        ...
        <div id="content" class="app-content p-4 m-1">
            <div class="container main-content">
                ...
                <div class="city-header mb-4">
                    <h1 class="display-4" id="dynamicCityName">Add New City</h1>
    ...
    <div class="row ">
            ...
            <div class="quick-access-item col-md-2">
                ...
                <div class="url-input-container"  id="car_btn_div">
                    <input type="text" name="car_url" id="car_url" class="form-control url-input" 
            ...
            <div class="quick-access-item col-md-2">
                ...
                <div class="url-input-container"  id="estate_btn_div">
                    <input type="text" name="estate_url" id="estate_url" class="form-control url-input" 
            ...
            <div class="quick-access-item col-md-2">
                ...
                <div class="url-input-container"  id="hotel_btn_div">
                    <input type="text" name="hotel_url" id="hotel_url" class="form-control url-input" 
            ...
            <div class="quick-access-item col-md-2">
                ...
                <div class="url-input-container"  id="restaurant_btn_div">
                    <input type="text" name="restaurant_url" id="restaurant_url" class="form-control url-input" 
            ...
            <div class="quick-access-item col-md-2">
                ...
                <div class="url-input-container"  id="coffee_btn_div">
                    <input type="text" name="coffee_url" id="coffee_url" class="form-control url-input" 
            ...
            <div class="quick-access-item col-md-2">
                ...
                <div class="url-input-container"  id="bars_btn_div">
                    <input type="text" name="bars_url" id="bars_url" class="form-control url-input" 
                ...
                <div id="addCityForm">
                            ...
                            <div class="col-md-12 mb-3">
                                <div class="currency-image-upload">
                                    ...
                                    <div class="image-preview mt-2" id="cityPreview">
                                        <img src="" alt="City preview" style="max-width: 100%; display: none;">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="url" name="city_video" class="form-control" id="video_url">
                    ...
                    <div class="form-section">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="url" name="city_map" class="form-control" id="map_url">
                    ...
                    <div class="form-section">
                        ...
                        <div class="wpsm_panel mb-3">
                            ...
                            <div class="wpsm_panel-body">
                                <textarea class="form-control" name="best_time" rows="3" id="best_time"  placeholder="Enter best time to visit information"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="wpsm_panel mb-3">
                            ...
                            <div class="wpsm_panel-body" style="display: none;">
                                <textarea class="form-control" name="transportation" rows="3" id="transportation"  placeholder="Enter transportation information"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="wpsm_panel mb-3">
                            ...
                            <div class="wpsm_panel-body" style="display: none;">
                                <textarea class="form-control" name="weather" rows="3" id="weather"  placeholder="Enter weather information"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="wpsm_panel mb-3">
                            ...
                            <div class="wpsm_panel-body" style="display: none;">
                                <textarea class="form-control" rows="3" placeholder="Enter additional information" id="information" name="information"></textarea>
                            </div>
                        </div>
                    </div>
...
function previewImage(input, previewId) {
    ...
    document.getElementById('map_url').addEventListener('focusout', function () {
        ...
        if (googleMapsRegex.test(extractedUrl)) {
            ...
            console.log('Iframe Updated:', mapPreview.innerHTML);
        } else {
...
<script>
    function SaveCity(Clicked) {
     ...
     // Validate images
     const cityImage = document.getElementById('cityImage').files[0];
     if (!cityImage) {
         alert("City Image is required.");
         document.getElementById('cityImage').focus();
         return;
     } 
