...
<head>
	<meta charset="utf-8">
	<title>WORLD ADMIN | Fixed Footer</title>
...
<body>
	...
	<div id="app" class="app app-footer-fixed">
		...
		<div id="content" class="app-content">
			...
			<p>
				Add the <code>.app-fixed-footer</code> css class to <code>.app</code> container for fixed footer page setting.
			</p>
			
			<div class="card">
				<div class="hljs-container border-0">
					<pre><code class="xml" data-url="assets/data/layout-fixed-footer/code-1.json"></code></pre>
				</div>
